...
<body>
<div class="container">
      <form name="myForm" class="form-signin" action="frame3/index.html" method="post" onsubmit="return checkForm()">
		...
		<label class="radio inline">
			<input id="user" type="radio" name="userType" value="user" ${userType==2?'checked':''} /> 宿舍管理员
		</label>
