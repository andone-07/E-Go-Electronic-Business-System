   ...
   <table border="1"
     ...
     <c:forEach var="o" items="${list }">
       <tr>
         ...
         <td>${o.orPhone }</td>
         <td>
         <a   href="OrderServlet?id=${g.id}&action=toUpdate">修改</a> 
         <a  href="#" onclick="deleteOrder(${o.id })">删除</a> 
         <a href="#" onclick="handlingOrder(${o.id })">订单处理</a></td>
...
<script type="text/javascript">
    ...
    //            url: bootPATH + "../demo/CommonLibs/EmployeeWindow.html",
                ...
                title: "新增订单", width: 600, height: 400,
            });
        }
		</script>
