...
public class SqlHelper {
	...
	private static String url = "jdbc:mysql://localhost:3306/plusoft_test?useUnicode=true&characterEncoding=GBK";
...
//		private static  String pwd="";
	...
	public static ArrayList queryPage(String sql, HashMap param, int pageIndex, int pageSize)
    {
        ...
        //sqlserver 2012
        //select * from �? 	OFFSET PageIndex*pagenum ROWS FETCH next pagenum rows only
    }
